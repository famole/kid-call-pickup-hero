  ...
  public: {
    Tables: {
      activity_classes: {
        ...
        Relationships: [
          {
            foreignKeyName: "activity_classes_activity_id_fkey"
            columns: ["activity_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "activity_classes_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
      ...
      post_classes: {
        ...
        Relationships: [
          {
            foreignKeyName: "post_classes_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "classes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "post_classes_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
      ...
      post_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "post_reactions_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "parents"
            referencedColumns: ["id"]
      ...
      post_reads: {
        ...
        Relationships: [
          {
            foreignKeyName: "post_reads_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "parents"
            referencedColumns: ["id"]
