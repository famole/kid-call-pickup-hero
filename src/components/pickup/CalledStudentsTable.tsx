...
const CalledStudentsTable: React.FC<CalledStudentsTableProps> = ({
      ...
      return (
        <div className="w-full space-y-3">
          <div className="flex items-center gap-2 px-1">
            <CheckCheck className="h-5 w-5" />
            <h2 className="text-lg font-semibold">{t('pickup.currentlyCalled', { count: 0 })}</h2>
          </div>
          {emptyStateContent}
        </div>
      );
  ...
  return (
    <div className="w-full space-y-3">
      <div className="flex items-center gap-2 px-1">
        <CheckCheck className="h-5 w-5" />
        <h2 className="text-lg font-semibold">{t('pickup.currentlyCalled', { count: requests.length })}</h2>
      </div>
