...
The Metro configuration also defines `nodeModulesPaths` so modules installed at
the repo root (like `@supabase/supabase-js`) can be resolved when bundling the
Expo app.
