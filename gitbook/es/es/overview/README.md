---
description: >-
  Esta sección te muestra cómo usar Upsy como padre o madre para solicitar el
  retiro de tus hijos del colegio de manera rápida, simple y segura.
hidden: true
---
...
{% hint style="info" %}
Los usuarios en Upsy son precargados por los colegios, en caso que tengas problemas para iniciar sesión no dudes en contactar al Administrador del colegio.
{% endhint %}
